                ...
                children: [
                  MaterialButton(
                    ...
                    child: Image.asset(
                      ...
                      color: index == 0 ? Color(0xff871df1) : Colors.grey,
                      height: 24,
                    ),
                  ),
                  MaterialButton(
                    ...
                    child: Image.asset(
                      ...
                      color: index == 1 ? Color(0xff871df1) : Colors.grey,
                      height: 24,
                    ),
                  ),
                  MaterialButton(
                    ...
                    child: Image.asset(
                      ...
                      color: index == 2 ? Color(0xff871df1) : Colors.grey,
                      height: 24,
                    ),
                  ),
                  MaterialButton(
                    ...
                    child: Image.asset(
                      ...
                      color: index == 3 ? Color(0xff871df1) : Colors.grey,
                      height: 30,
                    ),
                  )
                ],
